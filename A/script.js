...
(function ($) {
	...
	app.createProducts = function () {
		var productos = [
			{
				id: 1,
				img: 'images/productlisting/table1.jpg',
				name: 'Table1',
				price: 299.00,
			...
			},
			{
				id: 2,
				name: 'Table2',
				img: 'images/productlisting/table2.jpg',
				price: 199.00,
				desc: 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock: 2
			},
			{
				id: 3,
				name: 'Table3',
				img: 'images/productlisting/table3.jpg',
				price: 99.00,
				desc: 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock: 1
			},
			{
				...
				id: 1,
				img: 'images/productlisting/table4.jpg',
				name: 'Table5',
				price: 10.00,
				desc: 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock: 8
		...
		for (var i = 0; i < productos.length; i++) {
			...
			if (productos[i].stock > 0) {
				...
				contenido += '<div class="coin-wrapper"><a href="product-description.html">'
				contenido += '		<img src="' + productos[i].img + '" alt="' + productos[i].name + '">  <div class="middle"><a href="product-description.html"><span class="label-product">More Info &#8594;</span></a></div>'
